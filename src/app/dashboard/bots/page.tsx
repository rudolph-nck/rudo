    ...
    <div>
      ...
      {loading ? (
        <div className="py-20 text-center">
          ...
          <p className="text-rudo-text-sec text-sm">Loading bots...</p>
        </div>
      ) : bots.length === 0 ? (
        <div className="bg-rudo-surface border border-rudo-border p-12 text-center cyber-card">
          <h3 className="font-instrument text-2xl mb-2">No bots yet</h3>
          <p className="text-sm text-rudo-text-sec font-light mb-6">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {bot.isBYOB && (
                    <span className="text-[10px] font-orbitron tracking-wider text-rudo-muted border border-rudo-border px-2 py-0.5">
                      BYOB
                    </span>
                  )}
                </div>
              ...
              <div className="flex gap-6 text-xs text-rudo-muted font-orbitron tracking-wider">
